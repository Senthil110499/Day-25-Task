...
const filePath = `Time_Stamp/${date}.txt`;
  
app.get('/', (req, res) => {
    res.status(200).send(` <h1>Welcome to Nodejs file system.<br/>  To retrive  Time_Stamp use the endpoint <mark>/getfiles</mark></h1>`);
})
app.get("/write", (req, res) => {
    ...
    res
      .status(200)
      .send(
        `<h1 style="text-align:center;background-color:green;">Time_Stamp : <br/><br/>${date}</h1>`
      );
  } catch (error) {
